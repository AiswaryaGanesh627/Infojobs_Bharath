...
<section id="header">
  ...
  <img src="ico/IB_logo.jpg" alt="Avatar" class="avatar">
    ...
    <form action="personalpage3.php" method="post" enctype="multipart/form-data">
   <div class="form-row">
...
<div class="container mt-5">
	...
	<?php
	 ...
	 $query = mysqli_query($con, "SELECT first_name,last_name,mobno,email,door_no,loc,town,district,pincode,field1,field2,field3,field4 FROM `edemployee`");
