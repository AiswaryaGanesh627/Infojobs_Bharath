...
.image-career-banner {
    background: linear-gradient(rgba(0,0,0,.2), rgba(0,0,0,.2)), url(./img/004.jpg);
...
<section id="header">
  ...
  <img src="ico/IB_logo.jpg" alt="Avatar" class="avatar">
    ...
    <form action="personalpage2.php" method="post" enctype="multipart/form-data">
   <div class="form-row">
...
<h4 align="left"> Address</h4>
 ...
 <div class="form-row">
    ...
    <h4 align="left">Working skills</h4>
...
<div class="container mt-5">
  <h3 align="center"><b>Available Jobs</b></h3>
	 <br>
	 
	<?php
	
	 $email=$_SESSION['email'];
	 $query = mysqli_query($con, "SELECT first_name,last_name,mobno,email,door_no,loc,town,district,pincode,field1,field2,field3,field4 FROM `edemployer`");
	 if(mysqli_num_rows($query) > 0)
      {
		 while($row = mysqli_fetch_assoc($query)) {
        echo "<h5><b>" . $row["first_name"]. "  " . $row["last_name"]. "</b></h5><h6>Phone number: " . $row["mobno"]. "</h6><h6> Email: " . $row["email"]. "</h6><h6>Address: " . $row["door_no"]. "  " . $row["loc"]. "</h6><h6>" . $row["town"]. "  " . $row["pincode"]. "</h6><h6>" . $row["district"]. "</h6><h5><b>Hiring for</b></h5><h6>Work: " . $row["field1"]. "</h6><h6>Duration: " . $row["field2"]. "</h6><h6>From-To: " . $row["field3"]. "</h6><h6>Wage alloted: " . $row["field4"]. "</h6><br><br>";
    }
} else {
    echo "0 results";
}
